...
import portfolio11Img from '@img/sub/sub-11.jpg'
          ...
          <div className="row gy-4">
                  ...
                  <div className="portfolio-details-slider swiper init-swiper" data-aos="zoom-in">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <img src={portfolio11Img} alt="Portfolio Image" className="img-fluid" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-6" data-aos="fade-left">
              <div className="portfolio-details-content">
                ...
                <h2 className="project-title">한림 ERP 구축</h2>

                <div className="project-overview">
                  <p className="lead">한림인텍의 ERP를 구축하였습니다.</p>
                  <br />
                      ...
                      <div id="portfolio-details-collapse-1" className="accordion-collapse collapse show" data-bs-parent="#portfolio-details-projectAccordion">
                        <div className="accordion-body">
                          <ul className="achievements">
                            <li>개발 환경 : Spring Boot 3.1.* , java 11, thymeleaf,DevExtreme, javascript, jQuery, Bootstrap</li>
                            <li>DB : MSSQL</li>
                            <li>세션,캐시 : Redis</li>
